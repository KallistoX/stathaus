...
* **ui:** Fix mobile menu login/logout button click handlers ([67d742d](https://github.com/KallistoX/stathaus/commit/67d742d9ae9b70a4231b4a1920a212f78b5562de))

# [1.9.0](https://github.com/KallistoX/stathaus/compare/v1.8.0...v1.9.0) (2026-01-24)


### Features

* Add mobile burger menu and PWA update prompt ([2d4fb61](https://github.com/KallistoX/stathaus/commit/2d4fb61552936024a28ce7b3e8a53f1c02392498))
...
* Resolve cloud sync, monthly breakdown, and UI bugs ([6c848a3](https://github.com/KallistoX/stathaus/commit/6c848a34d5f0d603231206985dcf26f59c245dd6))
...
* **ci:** Disable body line length limit for semantic-release commits ([425dffa](https://github.com/KallistoX/stathaus/commit/425dffa97687faed5cf140d1a7e7be0b980287bb))
* **ci:** Remove npm cache requirement for Docker-only dev environment ([98c71ad](https://github.com/KallistoX/stathaus/commit/98c71adca239c28951b4d53d6a40d9bd94465ee5))


### Features

* Add automated semantic versioning and CI/CD release pipeline ([78bb604](https://github.com/KallistoX/stathaus/commit/78bb6047c8c9c2916f23c5a9ae242dbe33961e67))
