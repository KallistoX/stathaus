  ...
  <div class="fixed inset-0 z-50 overflow-y-auto" @click.self="$emit('close')">
    <div class="flex min-h-screen items-center justify-center p-4">
      ...
      <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full p-6">
        <!-- Header -->
        <div class="mb-4">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add Group</h3>
          <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
            Create a group to organize meters by location or property
          </p>
        </div>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Berlin Apartment, Main House"
              >
            </div>
            ...
            <div>
              ...
              <input
                ...
                type="text"
                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                placeholder="e.g. All meters for the rental property"
              >
            </div>
